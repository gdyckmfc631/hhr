...
UUID=${UUID:-'e2ecd3ab-105c-4555-906a-fa5218d072d4'}
VMESS_WSPATH=${VMESS_WSPATH:-'/e2ecd3ab-105c-4555-906a-fa5218d072d4-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/e2ecd3ab-105c-4555-906a-fa5218d072d4-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/e2ecd3ab-105c-4555-906a-fa5218d072d4-trojan'}
SS_WSPATH=${SS_WSPATH:-'/e2ecd3ab-105c-4555-906a-fa5218d072d4-shadowsocks'}
